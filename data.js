...
const WORKS = [
  ...
  { category: "philosophy", written: 105, pub: 110, code: "PH07", title: "The Symphony of Existence — From the Big Bang to the Illusion of Time", status: "published", url: "https://books2read.com/u/bOV1VK" },
  ...
  { category: "readers",              pub: 49, code: "R03",    level: "A1.1", title: "Max the Brave and The Runaway", note: "bundle", status: "published", url: "https://amazon.es/dp/B0F6T4CS9R?tag=rjpamazon-21" },
  { category: "readers", written: 58, pub: 50, code: "R04",    level: "A1.2", title: "The Mystery of the Missing Cake", status: "published", url: "https://books2read.com/u/3JA9DP/?tag=rjpamazon-21" },
  { category: "readers", written: 59, pub: 51, code: "R05",    level: "A1.2", title: "The Dead Cat on My Doorstep", status: "published", url: "https://books2read.com/u/31oZG6" },
  { category: "readers",              pub: 52, code: "R06",    level: "A1.2", title: "The Dead Cat on My Doorstep and The Mystery of the Missing Cake", note: "bundle", status: "published", url: "https://amazon.es/dp/B0F6TNX7YV?tag=rjpamazon-21" },
  { category: "readers", written: 60, pub: 57, code: "R07",    level: "A2.1", title: "The Lighthouse Code", status: "published", url: "https://books2read.com/u/bzw1YZ" },
  { category: "readers", written: 61, pub: 58, code: "R08",    level: "A2.1", title: "The New Student", status: "published", url: "https://books2read.com/u/3Rgz9L" },
  ...
  { category: "readers",              pub: 66, code: "R16",    level: "A2.2", title: "The Alley Cat and Other Stories", note: "bundle", status: "published", url: "https://amazon.es/dp/B0FD7MGR8M?tag=rjpamazon-21" },
  { category: "readers", written: 67, pub: 67, code: "R17",    level: "B1.1", title: "Shadows at School", status: "published", url: "https://books2read.com/u/bPjAXx" },
  { category: "readers", written: 68, pub: 68, code: "R18",    level: "B1.1", title: "The Girl Who Wasn't There", status: "published", url: "https://books2read.com/u/317wYw" },
  { category: "readers", written: 69, pub: 69, code: "R19",    level: "B1.1", title: "The Secret Lab", status: "published", url: "https://books2read.com/u/3yp8DJ" },
  { category: "readers", written: 70, pub: 70, code: "R20",    level: "B1.2", title: "Digital Ghost", status: "published", url: "https://books2read.com/u/mv8AnV" },
  ...
  { category: "readers",              pub: 72, code: "R22",    level: "B1", title: "Shadows at School and Others", note: "bundle", status: "published", url: "https://amazon.es/dp/B0FD8QL5JN?tag=rjpamazon-21" },
  { category: "readers", written: 71, pub: 73, code: "R23",    level: "B1.2", title: "Second Skin", status: "published", url: "https://books2read.com/u/bQz8xD" },
  { category: "readers", written: 72, pub: 74, code: "R24",    level: "B1.2", title: "The Last Game", status: "published", url: "https://books2read.com/u/bMdLZk" },
  { category: "readers", written: 73, pub: 75, code: "R25",    level: "B1.2", title: "The Package", status: "published", url: "https://books2read.com/u/492YMM" },
  { category: "readers",              pub: 76, code: "R23-25", level: "B1.2", title: "Second Skin and Other Stories", note: "bundle", status: "published", url: "https://amazon.es/dp/B0FD8PMQGV?tag=rjpamazon-21" },
  { category: "readers", written: 74, pub: 77, code: "R27",    level: "B2.1", title: "The Disappearing Hour", status: "published", url: "https://books2read.com/u/bW2XN7" },
  ...
  { category: "readers", written: 83, pub: 89, code: "R38",    level: "C1.2", title: "The Memory Index", status: "published", url: "https://books2read.com/u/bzNpq9" },
  { category: "readers",              pub: 90, code: "R39",    level: "C1.2", title: "The Collapse and The Memory Index", note: "bundle", status: "published", url: "https://amazon.es/dp/B0FFN7GFK2?tag=rjpamazon-21" },
  { category: "readers", written: 84, pub: 91, code: "R40",    level: "C2.1", title: "The Archive of Vanishing Things", status: "published", url: "https://books2read.com/u/mYMRWY" },
  { category: "readers", written: 85, pub: 92, code: "R41",    level: "C2.1", title: "Under the Skin", status: "published", url: "https://books2read.com/u/3kzZQN" },
  { category: "readers",              pub: 93, code: "R42",    level: "C2.1", title: "The Archive of Vanishing Things and Under the Skin", note: "bundle", status: "published", url: "https://amazon.es/dp/B0FFMZW73V?tag=rjpamazon-21" },
  { category: "readers", written: 86, pub: 94, code: "R43",    level: "C2.2", title: "Clean Slate", status: "published", url: "https://books2read.com/u/47pkBE" },
  { category: "readers", written: 87, pub: 95, code: "R44",    level: "C2.2", title: "Underneath Her Smile", status: "published", url: "https://books2read.com/u/bQoZ7v" },
  { category: "readers",              pub: 96, code: "R45",    level: "C2.2", title: "Clean Slate and Underneath Her Smile", note: "bundle", status: "published", url: "https://amazon.es/dp/B0FFN4XCY?tag=rjpamazon-21" },
  ...
  { category: "novellas-flash-fiction", written: 40,   pub: 42,  code: "NFF2S",  title: "Misterio al revés", language: "Spanish", note: "flash fiction · translation of T01", status: "published", url: "https://books2read.com/u/mYkPWx" },
  { category: "novellas-flash-fiction", written: 41,   pub: 43,  code: "NFF3S",  title: "Un crimen por deshacer", language: "Spanish", note: "novelette · translation of T02", status: "published", url: "https://books2read.com/u/bp250q" },
  ...
  { category: "novellas-flash-fiction", written: "90", pub: 101, code: "NFF7E", title: "A Café called Zuflucht", language: "English", note: "novella", status: "published", url: "https://books2read.com/u/mvQvOq" },
  { category: "novellas-flash-fiction",                pub: 97,  code: "NFF7G",  title: "Ein Café namens Zuflucht", language: "German", note: "novella", status: "published", url: "https://books2read.com/u/mYJX9W" },
  { category: "novellas-flash-fiction",                pub: 98,  code: "NFF7S",  title: "Una Cafetería llamada Zuflucht", language: "Spanish", note: "novella", status: "published", url: "https://books2read.com/u/mVJpkA" },
  { category: "novellas-flash-fiction",                pub: 99,  code: "NFF7F",  title: "Un Café Nommé Zuflucht", language: "French", note: "novella", status: "published", url: "https://books2read.com/u/boJR6R" },
  { category: "novellas-flash-fiction",                pub: 100, code: "NFF7I", title: "Un café chiamato Zuflucht", language: "Italian", note: "novella", status: "published", url: "https://books2read.com/u/bWM9WM" },
  { category: "novellas-flash-fiction", written: 91,   pub: 102, code: "NFF8", title: "L'Apagada", language: "Valencian", note: "novelette", status: "published", url: "https://books2read.com/u/3ykgNZ" },
  ...
  { category: "language-learning",                 pub: 104, code: "LL1S",  title: "Cómo superar cualquier obstáculo para estudiar", language: "Spanish", status: "published", url: "https://books2read.com/u/m2WV16" },
  { category: "language-learning",                 pub: 105, code: "LL1F",  title: "Comment surmonter tout obstacle à l'étude", language: "French", status: "published", url: "https://books2read.com/u/bWM1LD" },
  { category: "language-learning", written: 95,    pub: 106, code: "LL2",   title: "Technical English in 2026", status: "published", url: "https://books2read.com/u/4Xp2Q7" },
  { category: "language-learning", written: 96,    pub: 111, code: "LL3",   title: "Automatic Mind — Engineering the Subconscious for Language Mastery", status: "published", url: "https://www.amazon.es/dp/B0H1R23NCY?tag=rjpamazon-21" },
  { category: "language-learning", written: 97,    pub: 113, code: "LL4",   title: "Speak Naturally! Part 1 (A2–B1)", status: "published", url: "https://www.amazon.es/dp/B0HFSNDD4N?tag=rjpamazon-21" },
  { category: "language-learning", written: 98,    pub: 114, code: "LL5",   title: "Speak Naturally! Part 2 (B1–B2)", status: "published", url: "https://www.amazon.es/dp/B0HFT8YKG8?tag=rjpamazon-21" },
  { category: "language-learning", written: 99,    pub: 115, code: "LL6",   title: "Speak Naturally! Part 3 (B2–B2+)", status: "published", url: "https://www.amazon.es/dp/B0HF56GBTR9?tag=rjpamazon-21" },
  { category: "language-learning",                 pub: 116, code: "LL4-6", title: "Speak Naturally! Box Set, Parts 1–3 (A2–B2+)", note: "bundle", status: "published", url: "https://www.amazon.es/dp/B0HFWJY4V3?tag=rjpamazon-21" },
  ...
  { category: "thrillers", written: "109S", pub: 118, code: "T1S", title: "Bicameral", language: "Spanish", status: "published", url: "https://www.amazon.es/Bicameral-lenguaje-conciencia-orígenes-Spanish-ebook/dp/B0HHFBBKJL?tag=rjpamazon-21" },
  ...
  { category: "sci-fi", written: 100, code: "SF2", title: "The Universe in Extremis", status: "editing", url: "" },
