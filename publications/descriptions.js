...
(function () {
  ...
  const SHORT_DESCRIPTIONS = {
    ...
    "The Universe":
"The Universe is the combined saga of The Universe in Extremis and The Universe Extra Maxhina. It follows humanity's attempt to understand the nature of reality itself as six cosmonauts and an android navigator journey beyond the Solar System, culminating in a fifty-year journey toward the limits of information, reality, and the universe. Rooted in real relativity and astrophysics, the two parts together ask what the universe is, and what we become in pursuit of the answer.",
