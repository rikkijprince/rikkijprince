...
(function () {
  ...
  // ---------------- Novellas & Flash Fiction ----------------
   ...
   "The Universe":
"El Universo es la saga que aúna El Universo in Extremis y El Universo Extra Maxhina. Narra el intento de la humanidad por comprender la naturaleza misma de la realidad, mientras seis cosmonautas y un navegante androide viajan más allá del Sistema Solar, que culmina en un viaje de cincuenta años en búsqueda de los límites de la información, la realidad y el universo. Basadas en la relatividad y la astrofísica reales, ambas partes se preguntan qué es el universo y en qué nos convertimos al buscar la respuesta",
